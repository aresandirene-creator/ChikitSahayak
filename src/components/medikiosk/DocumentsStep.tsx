  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <h2 className="mt-3 text-2xl sm:text-3xl font-bold text-emerald-900">{t("documentsTitle")}</h2>
        ...
        <CardContent className="p-5 space-y-4">
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-end">
            <div className="space-y-1.5 flex-1">
              <Label className="text-emerald-900">{t("documentsTypeLabel")}</Label>
          ...
          >
            ...
            <div className="text-sm font-medium text-emerald-800">{t("documentsDropzone")}</div>
        ...
        <CardContent className="p-4">
          ...
          {doc.status === "completed" && (
            <div className="mt-3 space-y-3">
              {diagnoses.length > 0 && (
                <div>
                  <div className="text-xs font-semibold text-emerald-800 mb-1">{t("documentsExtractedDiagnoses")}</div>
              ...
              {procedures.length > 0 && (
                <div>
                  <div className="text-xs font-semibold text-emerald-800 mb-1">{t("documentsExtractedProcedures")}</div>
